...
function bravepop_popupjs_vars() { 
   ...
   print_r('<script> var brave_popup_data = {}; var bravepop_emailValidation='.json_encode($emailValidator).'; var brave_popup_videos = {};  var brave_popup_formData = {};var brave_popup_adminUser = '.json_encode(is_user_logged_in() &&current_user_can('administrator') ? true : false).'; var brave_popup_pageInfo = '.( function_exists('bravepop_get_current_pageInfo') ? json_encode(bravepop_get_current_pageInfo()) :'{}').';  var bravepop_emailSuggestions={};</script>');
}