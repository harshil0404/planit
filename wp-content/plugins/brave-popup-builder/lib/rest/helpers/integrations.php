...
function bravepop_add_to_newsletter($actionType='form', $type, $emailValue, $listID, $nameValue='', $phoneValue='', $customFields=array(), $tags=array(), $userData=array(), $doubleOptin=false, $misc=array()){
