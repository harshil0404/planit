...
if ( ! class_exists( 'BravePop_Element_Form' ) ) {
   ...
   class BravePop_Element_Form {
      ...
      protected function renderInput($field){
         ...
         $isHidden = !empty($field->hidden) ? 'brave_form_field--input_hidden': '';
         ...
         $fieldHTML = '<div id="brave_form_field'.$field->id.'" class="brave_form_field brave_form_field--input '.$isHidden.'">';
            if(isset($field->validation) && $field->validation === 'name'){
               ...
               if(isset($field->validation) && $field->validation === 'email'){
                  $fieldHTML .= '<input type="email" placeholder="'.esc_attr($placeholder).'"  name="'.esc_attr($firstname).'" '.($defaultValue).' class="'.($newsletter_email_field === $field->id ? 'brave_newsletter_emailField' : '').'" />';
               }else{
                  $fieldHTML .= '<input type="text" placeholder="'.esc_attr($placeholder).'"  name="'.esc_attr($firstname).'" '.($defaultValue).' class="'.($newsletter_name_field === $field->id ? 'brave_newsletter_nameField' : '').'" />';
               }
      ...
      protected function renderTextarea($field){
         ...
         $fieldHTML = '<div id="brave_form_field'.$field->id.'" class="brave_form_field brave_form_field--textarea">';
            ...
            $fieldHTML .= '<div class="brave_form_field_error"></div>';
            $fieldHTML .= '<textarea placeholder="'.esc_attr($placeholder).'" name="'.esc_attr($fieldName).'" style="height:'.esc_attr($height).'" >'.$defaultValue.'</textarea>';
         $fieldHTML .= '</div>';
