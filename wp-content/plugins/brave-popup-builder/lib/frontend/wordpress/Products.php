               ...
               $postHTML .= '<div class="brave_product__chunk '.$slideClass. $hasBackgroundClass. $buttonAlwaysClass.'">';
                     foreach ($block as $theproduct) {
                        ...
                        $postHTML .=  '<div id="brave_product-'.$productID.'" class="brave_product">';
                           ...
                           $cartButton = '<a href="?add-to-cart='.$productID.'" '.$goalAction.' data-quantity="1" class="add_to_cart_button ajax_add_to_cart" data-product_id="'.$productID.'" data-product_sku="'.$productSKU.'" rel="nofollow">'.$cartIcons.$buttonText.'</a>';
