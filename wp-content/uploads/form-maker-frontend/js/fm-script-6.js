    ...
    var labels_and_ids6 = {"2":"type_text","3":"type_spinner"};
    var check_regExp_all6 = [];
    var check_paypal_price_min_max6 = [];
    var file_upload_check6 = [];
    var spinner_check6 = {"3":["",""]};
 ...
 function after_submit6() {
  ...
  jQuery("#form6 #wdform_3_element6").spinner({ min: ""});
  jQuery("#form6 #wdform_3_element6").spinner({ max: ""});
